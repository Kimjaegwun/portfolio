        ...
        <div className="container mx-auto pb-[100px]">
          ...
          >
            ...
            <span>
              ...
              &nbsp;2020년에 2년 넘게 근무하던 삼성전자를 나와 스타트업을
              시작하였습니다. 주로 웹/앱 서비스 개발을 담당하였으며 필요에 따라
              UI 디자인, 백엔드 등의 업무를 병행하였습니다. 그리고 서비스를
              운영하면서 다양한 경험을 얻을 수 있었고 또한 예상치 못한 이슈들에
              대처하며 트러블 슈팅 경험을 쌓을 수 있었습니다. <br />{" "}
              &nbsp;자기주도적인 개발 환경에 익숙하며 개발 관련 정보 공유를
              중요시합니다. 단순히 개발뿐만 아니라 비즈니스적으로도 관심을
              가지고 기여하는 일을 좋아합니다. 좋은 프로덕트 와 가치를 만들기
              위해서는 모든 팀원이 함께 만들어야 한다고 생각하기에 개발 시에
              여러 팀들과 소통하기 위해 노력합니다.
            </span>
