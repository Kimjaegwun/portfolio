...
export default function MainLayout({
  ...
  return (
    <div className="w-[800px] mx-auto h-screen p-3 text-white">
      <Head>{children}</Head>
    </div>
  );
}
      ...
      <div className="mb-5 relative flex">
        ...
        >
          <motion.button
            ...
            className="w-[150px] border-2 border-white flex py-1 rounded-md items-center justify-center"
          >
            Menu
            <motion.div
              variants={{
          ...
          >
            <Link href={"/main"}>
              <motion.li
                ...
                className="w-[150px] flex justify-center py-2 font-semibold text-gray-400"
              >
                Main
              </motion.li>
            </Link>
